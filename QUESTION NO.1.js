...
// For Loop condition
let studentname=[{"name":"NANDHAKUMAR", "bloodgroup":"B+ve"},
...
let college=[{"department":"automobile", "year":"2017" },]
 for (let x in college)
    ...
    // console.log(college[0].department,college[1].year)
    // console.log(college[1].department,college[1].year)
    // console.log(college[1].department,college[0].year)
    }
